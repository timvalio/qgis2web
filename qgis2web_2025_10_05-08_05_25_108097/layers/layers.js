...
lyr_0000_25833_reindriftsiidaomrade_shp_2.set('fieldLabels', {'objectid': 'no label', 'objtype': 'no label', 'navn': 'no label', 'eier': 'no label', 'produsent': 'no label', 'kvalitet': 'no label', 'forstedata': 'no label', 'oppdaterin': 'no label', 'areal': 'no label', 'areal_daa': 'no label', 'malemetode': 'no label', 'noyaktighe': 'no label', 'synbarhet': 'no label', 'verifiseri': 'no label', 'siidatyper': 'no label', 'status': 'no label', });
