...
lyr_0000_25833_reindriftreinbeitedistrikt_shp_1.set('fieldLabels', {'objectid': 'header label - always visible', 'objtype': 'header label - always visible', 'distkode': 'header label - always visible', 'eier': 'header label - always visible', 'produsent': 'header label - always visible', 'kvalitet': 'header label - always visible', 'forstedata': 'header label - always visible', 'oppdaterin': 'header label - always visible', 'areal': 'header label - always visible', 'malemetode': 'header label - always visible', 'noyaktighe': 'header label - always visible', 'synbarhet': 'header label - always visible', 'verifiseri': 'header label - always visible', 'status': 'header label - always visible', });
lyr_0000_25833_reindriftsiidaomrade_shp_2.set('fieldLabels', {'objectid': 'header label - always visible', 'objtype': 'header label - always visible', 'navn': 'header label - always visible', 'eier': 'header label - always visible', 'produsent': 'header label - always visible', 'kvalitet': 'header label - always visible', 'forstedata': 'header label - always visible', 'oppdaterin': 'header label - always visible', 'areal': 'header label - always visible', 'areal_daa': 'header label - always visible', 'malemetode': 'header label - always visible', 'noyaktighe': 'header label - always visible', 'synbarhet': 'header label - always visible', 'verifiseri': 'header label - always visible', 'siidatyper': 'header label - always visible', 'status': 'header label - always visible', });
